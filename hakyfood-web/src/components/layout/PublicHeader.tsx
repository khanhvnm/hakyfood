      ...
      <div className="max-w-300 mx-auto w-full">
        <div className="flex justify-between items-center py-2">
          <div className="flex items-center">
            <div className="flex items-center gap-2">
              {isOpen ? (
                ...
                <>
                  <span className="relative flex justify-center items-center h-2.5 w-2.5">
                    <span className="animate-ping absolute h-full w-full rounded-full bg-gray-300"></span>
          ...
          <div className="flex items-center gap-3">
            <div id="notifications">
              <button type="button" className="flex items-center gap-1 text-xs text-white/70 hover:text-hk-secondary transition-colors duration-200 cursor-pointer">
            ...
            <div id="order-tracking">
              <Link to="/" className="flex items-center gap-1 text-xs text-white/70 hover:text-hk-secondary transition-colors duration-200">
                <svg className="w-4 h-4" viewBox="0 0 1024 1024" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div id="user-auth">
              {isLoggedIn ? (
                ...
                <div id="auth-links" className="flex items-center">
        ...
        <div id="main-header">
          ...
          <div id="main-header-right">
            ...
            <div id="search-bar">
              <form>
                <input type="text" placeholder="Tìm món ăn đêm yêu thích..." />
